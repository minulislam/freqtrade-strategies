...
class BinClucMadSMACore(IStrategy):
    INTERFACE_VERSION = 2
    ...
    smaoffset_sell_condition_0_enable = CategoricalParameter([True, False], default=True, space="sell", optimize=False, load=True)
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.v8_sell_condition_1_enable.value:
            conditions.append(((dataframe["rsi_1h"] > self.v8_sell_rsi_main.value) & (dataframe["volume"] > 0)))
